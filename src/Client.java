...
public class Client {
    ...
    public void sendMessage(TextArea ta, String msg) {
        try {
           ...
           // bufferedWriter.newLine();
            ...
            if (socket.isConnected()) {
            	...
            	//The very first msg to send to the clientHandler/server is the user/client name
    ...
    public void listenForMessage(TextArea ta) {
               ...
               // String msgFromGroupChat;
                ...
                while (socket.isConnected()) {
                    try {
                        ...
                        Platform.runLater(()->{
                        	ta.appendText(msgFromGroupChat + "\n");
                        });
    ...
    // Run the program using the concole as a chatbox
